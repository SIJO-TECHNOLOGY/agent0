...
- [ADR-016 - Keep One Warm Replica For The Public Web Front](./adr-016-web-warm-replica.md) - `agent0-web` leaves scale-to-zero for `minReplicas: 1`; a few euros a month buys away the 30 s - 1 min cold start on the first visit.
